...
class GameStateData:
    ...
    def initialize( self, layout, numGhostAgents ):
        ...
        # If the number of ghosts isn't reached
        # Then add the rest of the ghosts starting at the last know ghost
        remaining_ghosts = numGhostAgents - numGhosts
        if remaining_ghosts > 0:
            for _ in range(remaining_ghosts):
                self.agentStates.append( AgentState( Configuration( last_agent_pos, Directions.STOP), False) )
